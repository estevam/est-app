...
public class EncryptionUtil {
    ...
    private static final String MD2_ENCRYPTION_PASS ="MD2_ENCRYPTION_PASS";
	...
	public static synchronized String encrypt(String msg) {
		...
		try {
			...
			final String ENCRYPT_PASS = System.getenv(MD2_ENCRYPTION_PASS); // AES/GCM/NoPadding;

			Cipher cipher = Cipher.getInstance(ENCRYPT_ALGO);
			
			SecretKey aesKeyFromPassword = CryptoUtils.getAESKeyFromPassword(ENCRYPT_PASS.toCharArray(), salt);
	...
	public static synchronized String decrypt(String msg) {
		...
		try {
			...
			final String ENCRYPT_PASS = System.getenv(MD2_ENCRYPTION_PASS);
			
			aesKeyFromPassword = CryptoUtils.getAESKeyFromPassword(ENCRYPT_PASS.toCharArray(), salt);
			AlgorithmParameterSpec algorithmParameterSpec = new GCMParameterSpec(TAG_LENGTH_BIT, initVector);
